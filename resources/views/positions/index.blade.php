...
<div class="flex justify-between items-center mb-6">
    <div id="search">
        <form action="{{ route('positions.index') }}" method="get">
            <input name='search' autocomplete="off" type="text" id="searchInput" placeholder="Cari Position..." class="bg-white border-2 border-gray-500 text-gray-900 text-sm px-4 py-2 rounded-lg">
        </form>
    </div>
    <a href="{{ route('positions.create') }}" class="bg-gray-800 flex text-white px-4 py-2 rounded-lg hover:bg-gray-500 transition-colors">

    ...
    <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm mb-6 overflow-hidden">
        ...
        <div class="p-4 md:p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                ...
                <!-- Print -->
                <button onclick="window.print()" class="bg-purple-50 hover:bg-purple-100 border-2 border-purple-200 rounded-lg p-4 transition-colors duration-200 cursor-pointer">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-600">Cetak langsung</p>
                        </div>
                    </div>
                </button>
            </div>

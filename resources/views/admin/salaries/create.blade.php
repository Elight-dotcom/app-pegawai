    ...
    <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm overflow-hidden">
        <div class="bg-gray-800 px-4 md:px-6 py-4 border-b-2 border-gray-200">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-base md:text-lg font-semibold text-gray-300">Form Data Gaji</h2>
            </div>
        </div>

        <form action="{{ route('salaries.store') }}" method="POST" class="p-4 md:p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-gray-500">Gaji pokok akan otomatis terisi setelah memilih karyawan</p>
                    @error('gaji_pokok')
                    <p class="text-red-500 text-xs md:text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-yellow-700">Total Gaji akan dihitung otomatis: <strong>Gaji Pokok + Tunjangan - Potongan</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const monthOptions = bulanInput.options;

    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-8 mb-6 text-white">
        <div class="flex items-center gap-6">
            <div>
                ...
                <p class="text-blue-100 text-lg">{{ $employee->jabatan->nama_jabatan }}</p>
                <p class="text-blue-100 text-sm">{{ $employee->department->nama_departemen }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-base font-semibold text-gray-800">{{ Auth::user()->email }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm mb-6 overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b-2 border-gray-200">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-lg font-semibold text-gray-800">Informasi Karyawan</h2>
            </div>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm overflow-hidden">
            <div class="bg-gray-50 px-6 py-4 border-b-2 border-gray-200">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Departemen</h2>
                </div>
            </div>
            <div class="p-6">
                <div class="flex items-start gap-3">
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm overflow-hidden">
            <div class="bg-gray-50 px-6 py-4 border-b-2 border-gray-200">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Jabatan</h2>
                </div>
            </div>
            <div class="p-6">
                <div class="space-y-4">

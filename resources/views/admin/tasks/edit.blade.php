...
<div class="container mx-auto md:px-4 max-w-4xl mt-4 md:mt-8 mb-4 md:mb-8">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Update Task</h1>
    </div>
    ...
    <div class="bg-white border-2 border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="p-4 md:p-6">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="department_name" name="department_name"
                        ...
                        placeholder="Pilih employee terlebih dahulu" value="{{ old('department_name', $task->department->nama_departemen) }}" readonly>

                    <input type="hidden" id="department_id" name="department_id" value="{{ old('department_id', $task->department_id) }}">
                </div>
                ...
                <div class="space-y-2 lg:col-span-2">
                    ...
                    <input type="text" id="title" name="title"
                        ...
                        placeholder="Masukkan judul task" value="{{ old('title', $task->title) }}">
                    @error('title')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2 lg:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Tuliskan detail task...">{{ old('description', $task->description) }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-2 mt-6">
                ...
                <div id="subtasks-container" class="space-y-2">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" name="subtasks[]" value="{{ $subtask->title }}" placeholder="Subtask 1"
